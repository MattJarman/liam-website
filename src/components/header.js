            ...
            <div className="flex justify-between items-center border-b-2 border-gray-100 transition-colors duration-300 py-4 md:justify-start md:space-x-4 px-4 h-20">
              <div className="flex mr-2">
                <a className="cursor-pointer" href="/#top">
                  ...
                  <svg
                    className="w-8 h-8 text-primary-500 fill-current"
              ...
              <div className="-mr-2 -my-2 md:hidden">
                <button
                  ...
                  className="rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary-400"
                >
              ...
              <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0 space-x-4">
                ...
                {/*      target="_blank"*/}
                {/*      rel="noreferrer"*/}
                {/*      className="hover:text-primary-700 text-primary-500 w-6"*/}
                {/*    >*/}
                {/*      <Icon name={icon} />*/}
                {/*    </motion.a>*/}
                {/*  )*/}
              ...
              >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="-mr-2">
                      <button
                        type="button"
                        onClick={hide}
                        className="bg-white transition-colors duration-300 rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary-400"
                      >
                      ...
                      {menu.map(({ name, url, icon }, index) => {
                        return (
                          <Link
                            ...
                            activeClassName="text-primary-500"
                          >
                            <div className="flex items-center justify-center w-6 text-primary-500">
                              <Icon
                ...
                <div className="py-4 px-5">
                  <div className="flex items-center justify-end space-x-4">
                    ...
                    {/*      <Icon*/}
                    {/*        name={icon}*/}
                    {/*        className="text-primary-500 text-xl w-6"*/}
                    {/*      />*/}
                    {/*    </a>*/}
                    {/*  )*/}
                    {/*})}*/}
